...
<div><div class="form-group"><label class="control-label">Address</label>
<div class="control-input"><textarea    type="text" class="col-md-12 input-with-feedback form-control" data-fieldtype="Small Text" data-fieldname="address" placeholder="" data-doctype="Employee External Work History" style="max-height: 100px;"></textarea></div>
<div class="control-value like-disabled-input" style="display: none;"></div><p class="help-box small text-muted">  &nbsp;</p></div></div><div>
<div class="form-group" style="max-width: 600px;"><label class="control-label">Total Experience</label>
<div class="control-input"><input   type="text" class="col-md-12 input-with-feedback form-control" data-fieldtype="Data" data-fieldname="total_experience" placeholder="" data-doctype="Employee External Work History" style="max-height: 100px;"></div>
<div class="control-value like-disabled-input" style="display: none;"></div>
<p class="help-box small text-muted"> &nbsp;</p></div></div></div></div></div>
<div class="toolbar footer-toolbar" style="height: 36px;">
<span class="text-muted">
<a href="#" class="shortcuts"><i  class="icon-keyboard"></i> Shortcuts</a>
</span>
<button class="btn btn-success pull-right grid-toggle-row" title="Close" style="margin-left: 7px;">
...
<i class="icon-plus"></i></button></div> </div>