<div class="grid-row" data-idx="1">
    <div class="data-row" style="min-height: 26px; display: block; ">
            <div class="col col-xs-1 row-index">1</div>
            <div class="col col-xs-2 grid-overflow-ellipsis" > </div>
            <div class="col col-xs-2 grid-overflow-ellipsis" > </div>
            <div class="col col-xs-2 grid-overflow-ellipsis text-right" data-fieldname="salary">
                        <div style="text-align: right">N$ 0.00</div>
            </div>
            <div class="col col-xs-3 grid-overflow-no-ellipsis" data-fieldname="address"></div>
