          ...
          <div class="col-sm-12 col-md-offset-3 col-md-6">
            <div class="thumbnail info-thumbnail background-lead">
              <div class="caption">
                ...
                <form:form commandName="user" id="contact-form" name="register" method="post" action="register.htm">
                  <div class="form-group">
                    <label for="exampleInputName">Last Name</label>
                    <form:input cssClass="validate[required,custom[onlyLetter]] form-control" path="lastName" id="lastname"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputSecondName">First name</label>
                    <form:input cssClass="validate[required,custom[onlyLetter]] form-control" path="firstName" />
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail12">Email address</label>
                    <form:input  cssClass="validate[required,custom[email]] form-control" path="email" id="email" />
                    <form:errors cssClass="label label-warning" path="email" />
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword12">Password</label>
                    <form:password cssClass="validate[required] form-control" path="password" id="password"/>
                    <form:errors cssClass="label label-warning" path="password" />
                  </div>
                  <div class="form-group">
